...
\begin{itemize}
    ...
    \item Mesurer les courants  des inducteurs à l'aide d'une sonde de courant pour voir s'il donne une bonne force et quelle est la force max si l'on appuie dessus.
\end{itemize}
