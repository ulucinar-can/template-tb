...
\begin{itemize}
    \item PRéciser que c'est la dernière carte qui peut causer problème dans mes hypothèse - supprimer
    \item Préciser que le chap sur la maquette c'est le départ - ok
    \item PEtit dessins représentant les dimmensions de l'entrefer - ok
    \item Préciser le voc pour le dsp sur le shcéma electronique et mettre une photo - ok
    \item On peut parler du fait que Isoz a fait l'avant dernière carte, ensuite freyche a corriger mais que c'est possible qu'il y a encore des porblèmes d'ou le fait de mes hypothèses sur des problèmes lié a la carte. - ok
    \item Mentionner la plage qui  est max de l'adc par rapport au conditionneur dans le chap 2 - ok
    \item DOnner des précisions dans le protocole de service et mieux réaliser le protocole - ok
    \item PArler de problèmes possible dans la précharge que j'ai rencontré et qu'on peut vérifier la chose en utilisant la sonde d'oscilloscope -ok i think
    \item Changer l'emplacement de la calibration du capteur - ok
    \item Bien définir que le chapitre 2 est mon point de départ et ajouter un chapitre des modifs que j'ai réalisé sur la maquette -ok
    \item Ajouter ce que je veux faire dans l'intro des mesures - ok
    \item Mieux préciser que je parle de vérifier le circuit précharge et pas des condo - ok
    \item Pas utiliser le terme régulateur pour les convertisseurs - ok
    \item Pas bombarder le rapport de tableaux si c'est pas néscessaire. Par exemple les mettres dans l'annexe et dire que ça fonctionne comme avec les mesures de courants - ok
    \item Bien faire attention au fil rouge entre ce qui est important ou ce qui est juste vérifier - ok
    \item PRéciser ou je pose mes masses en ajoutant des photo et dire que c'est ajouter par inducteur - ok
    \item Expliquer mon raisonnement dérière le but de la mesure -ok
    \item Bien faire la présentation de ce que je mesure sur le courant. Bien expliquer le but Derrière - a revoir
    \item Expliquer que j'ai réalisé les mesures pour obtenir de la connaissance sur le fonctionnement de la maquette - ok
    \item Préciser la valeur de l'entrefer par rapport aux cales -  a refaire
    \item Préciser que c'est la mesure filtré(valeur moyenne) qui est envoyé a l'esp32 qui est alors afficher sur l'interface web. AJouter le code la valeur filtré - ok mais a revoir
    \item Garder la finalité sur la mesure de positions et mettre en annexe celle de départs pour expliquer mes démarches au débuts. - ok
    \item Améliorer le graphique qui montre la vue face pour expliquer mes angles. \red{C'est faux}. Faire que c'est une vue de côté coupé juste au milieu - ok
    \item Pour l'étalonnage de l'adc. Dire que j'améliore la conversion - a revoir
    \item Mieux apporter les sujets sur des mesures de positions. - ok
    \item Mettre le signe des erreurs - a faire
    \item Refaire le schéma de la régulation globale - ok
    \item changer l'ordre de un courant de consigne en une consigne de courant - ok
    \item Ajouter le diagramme de bode entre la simplifications et sans la simplification - ok
    \item Vérifier si on peut réellement faire la simplification - ig idk j'utilise pas ça de tt façon
    \item Faire la simu pour voir le comportement avec et sans la simplification - ok
    \item Vérifier que l'erreur du PI est bien mis en 100% - ok
    \item PAr rapport a ça voir si je peux pas prendre un N beaucoup plus grand - a essayer mais je pense pas
    \item Pour le le capteur de position, mettre ensemble le filtre savitzky. - ok
    \item Pour le pole minimum faudrait écrire que c'est le pole maximum, cad le meilleur amortissement. - ok
    \item Pour le PID revoir la manière dont c'est apporter. - a revoir
    \item A voir si je veux garder juste le PID ou si je part plus loin - ok
    \item Changer le titre du chapitre 5 en programmtion du DSP - ok
    \item Pour tout ce qui est du manuel, utiliser de manière plus intéligente. Ne pas surcharger les infos de ces infos qui ne servent pas. -ok
    \item Rvérifier le H majuscale - ok
    \item Revoir la raison pour laquelle la fenetre du filtre savitzky - ok
    \item Changer le titre du filtre IIR en coupe bande - ok
    \item Pour les mesures de temps, je peux utiliser un trigger voir s'il y a un moment qui dépasse le temps de 20 us. Si l'uart. - pas fait
    \item Pour la mesure de temps préciser que le flag était retirer pour enlever l'uart et observer le résultat - ok
