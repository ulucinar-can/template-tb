...
Cette annexe vient démontrer la première machine d'état développer dans le programme. Celui-ci avait pour but d'améliorer la machine d'état déjà existante mais possédant une architecture complexe et difficilement lisible. Le comportement séquentiel défini est le suivant :
...
Finalement, l'état 8 est définit comme une simple condition :
...
Il est également possible de sauter l'activation de l'avant ou de l'arrière. Pour se faire de \texttt{#define} furent réaliser en début du code comme suit :
...
La vérification d'une demande de saut de l'avant et de l'arrière se font dans l'état 0 et l'état 3.

Afin de permettre d'éteindre a n'importe quel moment la maquette, une simple condition au dessus de la machine d'état fut réalisé comme suit :
...
Celui-ci vérifie simplement que le bouton fut effectivement pressé en vérifiant qu'il est éteint mais également que l'état actuelle est différent de l'état 0 et l'état 8.