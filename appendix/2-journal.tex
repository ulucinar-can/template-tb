...
\begin{itemize}
    \item Création d'un Gantt pour un bon suivis du TB
\end{itemize}

\subsection*{27 février 2026}

\begin{itemize}
    \item Suite de la création d'un Gantt pour un bon suivis du TB
...
\begin{itemize}
    ...
    \item Lecture du code ()
    \item Documentation du code dans le rapport
    \item Entretien avec M.Girardin
\end{itemize}

\subsection*{4 mars 2026}
\begin{itemize}
    \item Suite ecriture du code
    \item Documentation du code dans le rapport
\end{itemize}
