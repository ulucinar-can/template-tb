...
Le calcul de l'erreur est réalisé en intégrant l'erreur lors d'un essai en régulation de maintien, ce qui correspond à la surface comprise entre la consigne et la réponse du système. L'évolution de cette surface en fonction de $N$ est présentée sur la figure \ref{fig:ErrorPID} :
