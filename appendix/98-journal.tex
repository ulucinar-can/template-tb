...
\begin{itemize}
    \item Finalisation du tableau de mesure
    \item Mesure des alimentations
\end{itemize}

Observation :
\begin{itemize}
    \item Le régulateur 24V a besoin d'une pression physique pour s'enclencher. Ce n'est pas normal. A cause de celui la, l'alimentation général n'est pas fonctionelle. En rebrassant les connecteurs, le régulateur fonctionne une nouvelle fois.
\end{itemize}

\subsection*{23 avril 2026}
\begin{itemize}
    \item Mesure général du capteur de courant
