...
Travaille réalisé :
\begin{itemize}
    \item Mettre dans l'ordre mon code
    \item Réfléchir pourquoi
    \item Méthode de mesures
    \item Mesure
    \item Modélisation des mesures
\end{itemize}

Pensé :
\begin{itemize}
    \item Ce serait bien de faire une simulation du code ou de vérifier lec omportement du système en simu. Pour vérifier le comportement théorique et le comportement réelle de la maquette avec les mesures.
\end{itemize}
