...
\begin{equation}
    ...
    + \left. \frac{\partial f_1}{\partial \delta} \right|_{i_n, \dot{\delta_n}, U_{d,n}}\cdot(\dot{\delta}-\dot{\delta_n})
...
\begin{equation}
    f_1(i_n, \delta_n, U_{d,n})  = \frac{U_ - R \cdot i}{L_n} \cdot \frac{\delta}{\delta_n} + \frac{i}{\delta} \cdot \dot{\delta}
\end{equation}
