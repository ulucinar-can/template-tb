...
Le système est fortement non-linéaire comme observer avec les équations \ref{eq:CourDerive} et \ref{eq:Accel}. Il est alors néscessaire de rendre ces équations linéaires pour la régulation de position.
