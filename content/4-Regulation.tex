...
\begin{equation}
    \left. \frac{\partial f_1}{\partial \dot{\delta}} \right|_{i_n, \dot{\delta_n}, U_{d,n}}\cdot(\dot{\delta}-\dot{\delta_n}) = \left. \left( \frac{i}{\delta} \right) \right|_{i_n, \dot{\delta_n}, U_{d,n}} = \frac{i_n}{\delta_n}
    \label{eq:DerivePart3}
\end{equation}

\begin{equation}
    \left. \frac{\partial f_1}{\partial U_d} \right|_{i_n, \dot{\delta_n}, U_{d,n}}\cdot (U_d-U_{d,n}) =
...
$$\left. \frac{\partial f_2}{\partial i} \right|_{i_n, \delta_n} = \left. \left( 0 - \frac{1}{\cancel{2}\cdot m}\cdot \cancel{2}\cdot i\cdot L_n \cdot\delta_n\cdot\frac{1}{\delta^2}\right) \right|_{i_n, \delta_n}$$

\begin{equation}
    \left. \frac{\partial f_2}{\partial i} \right|_{i_n, \delta_n} = -\frac{i_n\cdot L_n}{m \cdot\delta}
    \label{eq:DerivePart6}
\end{equation}

$$\left. \frac{\partial f_2}{\partial \delta} \right|_{i_n, \delta_n} = \left. \left( 0 - \frac{1}{2\cdot m}\cdot i^2\cdot L_n \cdot\delta_n\cdot\frac{-2}{\delta^3}\right) \right|_{i_n, \delta_n}
    = \frac{i_n^2\cdot L_n \cdot \delta_n}{m \cdot\delta^3}$$

\begin{equation}
    \left. \frac{\partial f_2}{\partial \delta} \right|_{i_n, \delta_n} = \frac{i_n^2\cdot L_n}{m \cdot\delta^2}
