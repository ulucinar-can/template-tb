...
\begin{itemize}
    ...
    \item La vitesse et l'accélération en ce point sont nuls($\dot{\delta}$ = $\ddot{\delta} = 0$).
    \item Un courant nominal traversent les bobines $i_n$
...
\begin{equation}
    f_1(i, \dot{\delta}, U_d) \approx f_1(i_n, \delta_n, U_{d,n})
    + \left. \frac{\partial f_1}{\partial i} \right|_{i_n, \dot{\delta_n}, U_{d,n}}\cdot\Delta{i}
    + \left. \frac{\partial f_1}{\partial \dot{\delta}} \right|_{i_n, \dot{\delta_n}, U_{d,n}}\cdot\Delta{\dot{\delta}}
    + \left. \frac{\partial f_1}{\partial U_d} \right|_{i_n, \dot{\delta_n}, U_{d,n}}\cdot\Delta{U_d}
    \label{eq:f1Lin1}
\end{equation}
...
\begin{equation}
    f_1(i_n, \delta_n, U_{d,n})  = \frac{U_{d,n} - R \cdot i_n}{L_n} \cdot \frac{\delta_n}{\delta_n} + \frac{i}{\delta} \cdot \dot{\delta} = 0
\end{equation}

\begin{equation}
    \left. \frac{\partial f_1}{\partial i} \right|_{i_n, \dot{\delta_n}, U_{d,n}} = \left. \Biggl(-\frac{R}{L_n}\cdot\frac{\delta}{\delta_n}+\frac{\dot{\delta}}{\delta}\Biggr) \right|_{i_n, \dot{\delta_n}, U_{d,n}} = -\frac{R}{L_n}\cdot\frac{\delta_n}{\delta_n}+0 = -\frac{R}{L_n}
\end{equation}

\begin{equation}
    \left. \frac{\partial f_1}{\partial \dot{\delta}} \right|_{i_n, \dot{\delta_n}, U_{d,n}}\cdot(\dot{\delta}-\dot{\delta_n}) = \left. \Biggl( \frac{i}{\delta} \Biggr) \right|_{i_n, \dot{\delta_n}, U_{d,n}} = \frac{i_n}{\delta_n}
\end{equation}

\begin{equation}
    \left. \frac{\partial f_1}{\partial U_d} \right|_{i_n, \dot{\delta_n}, U_{d,n}}\cdot (U_d-U_{d,n}) =
    \left. \Biggl( \frac{1}{L_n}\cdot\frac{\delta}{\delta_n} \Biggr) \right|_{i_n, \dot{\delta_n}, U_{d,n}} = \frac{1}{L_n}\cdot\frac{\delta_n}{\delta_n} = \frac{1}{L_n}
\end{equation}

L'équation \ref{eq:f1Lin1} devient alors :

\begin{equation}
    f_1(i, \dot{\delta}, U_d) \approx
    -\frac{R}{L_n} \cdot (i-i_n)
    + \frac{i_n}{\delta_n}\cdot(\dot{\delta}-\dot{\delta_n})
