...
Le système garde la même définition que les travaux précédents qui représenté par la figure \ref{fig:BobineRep} :
...
Puisque le projet repose principalement sur des bobines, l'equation de la tension induite au travers d'une bobine est donc essentielle. Le schéma électrique d'une bobine peut s'exprimer par la mise en série d'un inducteur et d'une résistance suivie d'une inductance. La somme des tensions de ces composants équivaut à la tension traversant la bobine. Elle se définit comme suit dans l'équation \ref{} :
...
\begin{itemize}
    \item $$ U_R = R \cdot i $$
    \item $$ U_L = \frac{d\Psi}{dt} = \frac{d}{dt}(L\cdot i)$$
\end{itemize}
