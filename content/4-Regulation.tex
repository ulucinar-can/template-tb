...
Pour la suite, les différents tracé se concentrerons sur le système correcte, c'est à dire le système ayant la constante ajouter.
...
Ceci avait pour conséquence de mal synthétiser le système donnant alors une mauvaise valeur de $K_{pi}$ comme observées dans les figures \ref{fig:BodeKpiFaux} et \ref{fig:BodeKpiFaux}
