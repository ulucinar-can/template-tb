...
Le développement en série de Taylor peut dès lors être appliqué.\\

La fonction $f_1$ se linéarise selon l'expression suivante :

\begin{equation}
    f_1(i, \delta, \dot{\delta}, U_d) \approx f_1(i_n, \delta_n, U_{d,n})
...
\begin{equation}
    \Delta i = i-i_n \qquad \Delta\dot{\delta} = \dot{\delta}-\overset{=0}{\cancel{\dot{\delta}_n}} = \dot{\delta} \qquad \Delta U_d = U_d-U_{d,n}
    \label{eq:DeltaDef}
\end{equation}
...
\begin{equation}
    f_1(i_n, \delta_n, \dot{\delta}_n, U_{d,n})  = \frac{\overset{=0}{\cancel{U_{d,n} - R \cdot i_n}}}{L_n} \cdot \frac{\delta_n}{\delta_n} + \frac{i}{\delta} \cdot \overset{=0}{\cancel{\dot{\delta}}} = 0
    \label{eq:DerivePart1}
\end{equation}

\begin{equation}
    \left. \frac{\partial f_1}{\partial i} \right|_{i_n, \delta_n, \dot{\delta}_n, U_{d,n}} = \left. \left(-\frac{R}{L_n}\cdot\frac{\delta}{\delta_n}+\frac{\dot{\delta}}{\delta}\right) \right|_{i_n, \delta_n, \dot{\delta}_n, U_{d,n}} = -\frac{R}{L_n}\cdot\frac{\delta_n}{\delta_n}+0 = -\frac{R}{L_n}
    \label{eq:DerivePart2}
\end{equation}

\begin{equation}
    \left. \frac{\partial f_1}{\partial \dot{\delta}} \right|_{i_n, \delta_n, \dot{\delta}_n, U_{d,n}} = \left. \left( \frac{i}{\delta} \right) \right|_{i_n, \delta_n, \dot{\delta}_n, U_{d,n}} = \frac{i_n}{\delta_n}
    \label{eq:DerivePart3}
\end{equation}

\begin{equation}
    \left. \frac{\partial f_1}{\partial U_d} \right|_{i_n, \dot{\delta}_n, U_{d,n}} =
    \left. \left( \frac{1}{L_n}\cdot\frac{\delta}{\delta_n} \right) \right|_{i_n, \dot{\delta}_n, U_{d,n}} = \frac{1}{L_n}\cdot\frac{\delta_n}{\delta_n} = \frac{1}{L_n}
    \label{eq:DerivePart4}
\end{equation}

En substituant les équations \ref{eq:DeltaDef}, \ref{eq:DerivePart1}, \ref{eq:DerivePart2}, \ref{eq:DerivePart3} et \ref{eq:DerivePart4} dans la relation \ref{eq:f1Lin1}, il vient :
...
\begin{equation}
    \left. \frac{\partial f_2}{\partial i} \right|_{i_n, \delta_n} = \left. \left( 0 - \frac{1}{\cancel{2}\cdot m}\cdot \cancel{2}\cdot i\cdot L_n \cdot\delta_n\cdot\frac{1}{\delta^2}\right) \right|_{i_n, \delta_n} = -\frac{i_n\cdot L_n}{m \cdot\delta_n}
    \label{eq:DerivePart6}
\end{equation}

\begin{equation}
    \left. \frac{\partial f_2}{\partial \delta} \right|_{i_n, \delta_n} = \left. \left( 0 - \frac{1}{2\cdot m}\cdot i^2\cdot L_n \cdot\delta_n\cdot\frac{-2}{\delta^3}\right) \right|_{i_n, \delta_n} = \frac{i_n^2\cdot L_n \cdot \delta_n}{m \cdot\delta_n^3}= \frac{i_n^2\cdot L_n}{m \cdot\delta_n^2}
    \label{eq:DerivePart7}
\end{equation}

En injectant les expressions \ref{eq:DeltaDef2}, \ref{eq:DerivePart5}, \ref{eq:DerivePart6} et \ref{eq:DerivePart7} dans la relation \ref{eq:f2Lin1}, on obtient :

$$    f_2(i, \delta) = \frac{d^2\delta}{dt^2} \approx
    -\frac{i_n\cdot L_n}{m \cdot\delta_n^2}\cdot(i-i_n)
    + \frac{i_n^2\cdot L_n}{m \cdot\delta_n}\cdot(\delta-\delta_n)$$
