...
Ceci à pour cause d'avoir un système à régler complétement différent. Comme observé sur les tracé suivant, on observe que le début du tracé débute en réalité non pas vers 0 mais vers les -40 dB :

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{assets/Chap4/BodeGaiFaux.png}
    \caption{Système à régler sans la constante multiplier}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{assets/Chap4/BodeGaiVrai.png}
