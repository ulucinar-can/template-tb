...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{assets/Chap4/SchemaBlocRegulation.jpg}
...
Une simulation a été réalisée par Laucelle \cite{Laucella}, prouvant l'efficacité du système avec et sans cette simplification :
...
Ces expressions permettent désormais d'entamer la synthèse de la régulation de courant.
