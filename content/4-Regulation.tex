...
Une fois les équations linéarisées, il est possible de les assembler afin d'obtenir un modèle d'état unique. Les relations à mettre en commun sont les équations \ref{eq:f1Lin2} et \ref{eq:f2Lin2} :
...
Une simulation fut réaliser par Luacella prouvant l'éfficacité du système avec et sans la simplification

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{assets/Chap4/ModélisationDeSimplification.png}
...
La régulation de courant vient être synthétiser par un PI. Celui-ci
