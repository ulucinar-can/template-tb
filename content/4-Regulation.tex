...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{assets/Chap4/SchemaBobine.png}
...
Le système est fortement non-linéaire comme observer avec les équations \ref{eq:CourDerive} et \ref{eq:Accel}. Il est alors néscessaire de rendre ces équations linéaires pour pouvoir régler le système. Pour cela, une linéarisation est réaliser par la méthode du développementde taylor. Il faut cependant définir un point de fonctionnement. Ce point sera définit au point nominal donc pour $\delta_n$, $i_n$ et $U_n$.
