...
\begin{equation}
    f_2(i_n, \delta_n) = \ddot{\delta}_n = 0
...
En injectant les équations \ref{eq:DeltaDef2}, \ref{eq:DerivePart5}, \ref{eq:DerivePart6} et \ref{eq:DerivePart7} dans l'équation \ref{eq:f2Lin1}, on obtient l'équation :

$$    f_2(i, \delta) = \frac{d^2\delta}{dt^2} \approx
    -\frac{i_n\cdot L_n}{m \cdot\delta}\cdot(i-i_n)
    + \frac{i_n^2\cdot L_n}{m \cdot\delta^2}\cdot(\delta-\delta_n)$$

$$    f_2(i, \delta) = \frac{d^2\delta}{dt^2} \approx
    -\frac{i_n\cdot L_n}{m \cdot\delta}\cdot i
    +\cancel{\frac{i_n^2\cdot L_n}{m \cdot\delta}}
    + \frac{i_n^2\cdot L_n}{m \cdot\delta^2}\cdot\delta
    -\cancel{\frac{i_n^2\cdot L_n}{m \cdot\delta}}$$
...
Une fois les équations linéariser, il est possible de les assembler afin d'avoir une unique équation. 
