...
À partir de la relation \ref{eq:Fele}, il est possible d'établir l'équation de la méthode inverse :
...
L'équation \ref{eq:MethInv} sera principalement employée dans le code source ainsi que pour le calcul des différents paramètres lors de l'étape de linéarisation \ref{subsec:lin}.
