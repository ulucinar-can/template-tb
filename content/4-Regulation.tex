...
Il est alors maintenant possible de réaliser le schéma simplié de la figure suivante :

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{assets/Chap4/RegPosBlocSimple.png}
    \caption{Schéma bloc simplifié de la régulation de position \cite{Laucella}}
