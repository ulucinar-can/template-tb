...
Comme décrit dans le rapport de Laucella \cite{Laucella}, il est possible de réaliser une analogie au moteur électrique. Dans celui-ci, l'accélération angulaire est définit par le courant ainsi qu'un couple de frottement, celle-ci pouvant être négligé ou non. Dans ce meme principe, il est possible d'assumer en comparant les deux équations que la position est la partie qui peut être néglié. C'est de ce fait que celle-ci sera négligé afin de faciliter la régulation de courant. 
