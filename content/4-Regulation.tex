...
\begin{equation}
    U = R \cdot i + L_n \frac{\delta_n}{\delta} \cdot \frac{di}{dt} - i \cdot L_n \frac{\delta_n}{\delta^2} \cdot \dot{\delta}
...
\begin{equation}
    \frac{di}{dt} = \frac{U - R \cdot i}{L_n} \cdot \frac{\delta}{\delta_n} + \frac{i}{\delta} \cdot \dot{\delta}
    \label{eq:CourDerive}
\end{equation}
...
\begin{equation*}
    \left\{ \begin{aligned}
        f_1(i, \dot{\delta}, U) = \frac{di}{dt} = \frac{U - R \cdot i}{L_n} \cdot \frac{\delta}{\delta_n} + \frac{i}{\delta} \cdot \dot{\delta} \\
...
\begin{equation}
    ...
    + \left. \frac{\partial f_1}{\partial i} \right|_{i_n, \dot{\delta_n}, U_{d,n}}
    + \left. \frac{\partial f_1}{\partial \delta} \right|_{i_n, \dot{\delta_n}, U_{d,n}}
...
\begin{equation}
    f_1(i_n, \delta_n, U_{d,n}) = 
\end{equation}

\begin{equation}
    \frac{\partial f_1}{\partial i} = \frac{}{}
\end{equation}
