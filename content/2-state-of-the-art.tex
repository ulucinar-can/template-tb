...
\section{Hardware}
La section suivante traite l'électronique réalisé dans la version initiale du projet.
...
\section{Software}
Cette section vient traiter le code réalisé jusqu'à maintenant. Elle essaiera d'expliquer au mieux possible les différentes partie du code allant des librairies utiliser jusqu'au intéruption.
...
\begin{itemize}
    ...
    \item \texttt{device.h} : Ce fichier est spécifique au microcontrolleur du DSP. Elle définit les fonctions d'initialisations de base pour que le matériel tourne à la bonne vitesse.
    ...
    \item \texttt{stdio.h} :  C'est une biblitohèque standards des entrées/sorties.
