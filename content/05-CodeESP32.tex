...
Il est dèsormais possible de flasher le code dans l'esp32. Pour se faire, il est néscessaire d'appuyer et maintenir le bouton "Boot" puis pressé une fois sur le bouton "reset".
...
Une fois fait, le code peut-être flasher dans l'esp32. Si une erreur s'affiche dans le terminal de l'arduino, cela est normal et la procédure a tout de même fonctionner
