\chapter{Situation de départ - Programme dans l'ESP32}
\label{sec:CodeESP32}

\section{Introduction}
Le microcontrôleur ESP32 est chargé de gérer la communication avec le DSP ainsi que d'héberger l'interface web. Ce chapitre détaille les différents éléments logiciels qui le composent.
