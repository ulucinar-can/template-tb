...
La mesure étant réaliser sur une période bien plus longue, la mesure complète sera disponible dans l'\autoref{label}.Les résultat présent ici se concentreront sur 10 sec comme suit :


Une fois cela réaliser, il est possible de réaliser une analyse sur les forces comme suit :


Il est possible de réaliser les écarts présent dans le \autoref{}
