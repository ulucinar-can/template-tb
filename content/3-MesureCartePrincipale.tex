...
Ceci a donc donné à l'essaie aux mesures présentes dans les tableaux \ref{tab:premier_etalonnage_code_capteurs}, \ref{tab:premier_etalonnage_code_cond} et \ref{tab:premier_etalonnage_code_adc} afin d'essayer une première tentative d'étalonnage dans le code :
...
A partir de cette mesure les tracés des figures  suivant a pu être réalisé :
