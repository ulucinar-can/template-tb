...
Afin de palière a cela, les 4 inducteurs ont été souelvé pui abaissé en suivant la démarche expliqué dans la section \ref{sec:CalibrationCaptPos}.
...
Par la suite une moyenne de chacune des valeurs a été réalisé pour obtenir le tableau suivant qui permettra de faire un tracé d'un poôlynome d'ordre 5. La raison du choix du polynôme d'ordre 5 est de garantir le passage par certaines valeurs cibles

\subsection{Première mesure des}
