...
\begin{itemize}
    ...
    \item Valeur maximale de l'ADC : 3723
\end{itemize}

La valeur max de l'adc étant 3723 dû au conditionneur allant de 0V à 3V. La tension de référence du DSP étant à 3.3V, celui-ci ne peut donc pas utiliser sa plage entière sur 12bit. Le max n'étant alors plus 4095 mais 3723.\\
