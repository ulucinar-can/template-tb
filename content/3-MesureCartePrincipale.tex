...
\begin{table}[H]
    ...
    \caption{Vérification générale des conditionneurs de courant (Partie 1 : capteurs 1 et 2)}
...
\begin{table}[h!]
    ...
    \caption{Vérification générale des conditionneurs de courant (Partie 2 : capteurs 3 et 4)}
...
\begin{table}[H]
    ...
    \caption{Mesures de courant par sonde (sans ajout de poids)}
...
\begin{table}[H]
    ...
    \caption{Mesures de courant par ADC (sans ajout de poids)}
...
\begin{table}[H]
    ...
    \end{tabular}%
    \caption{Comparatif des erreurs entre l'ADC et la sonde (sans ajout de poids)}
