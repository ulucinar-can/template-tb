...
Une première tentative fut réaliser avec un polynôme d'ordre 5 représente par le graphique \ref{} :



Le résultat n'étant pas concluant et ne semble pas laisser a la maquette d'avoir de la liberté, cet ordre fut baissé à un ordre 3 donnant donc le tracé du graphique \ref{} :



Le résultat n'étant toujours pas satisfaisant donna alors l'essaie d'une simple équation linéaire donnat le tracé du graphique \ref{} :
