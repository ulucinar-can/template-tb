...
\begin{table}[H]
    ...
    \label{tab:sans_poids_sonde_new}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:poids_1_25_sonde_new}
\end{table}
...
Le résultat n'étant pas concluant et ne semble pas laisser a la maquette d'avoir de la liberté, cet ordre fut baissé à un ordre 3 donnant donc les tracés des graphiques \ref{}, \ref{}, \ref{} et \ref{} :



Le résultat n'étant toujours pas satisfaisant donna alors l'essaie d'une simple équation linéaire donnat les tracés des graphiques \ref{}, \ref{}, \ref{} et \ref{} :
