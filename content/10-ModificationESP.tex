...
Le résultat final de cela est démontré dans la \autoref{fig:InterfaceFinal} :

\begin{figure}[H]
  \centering
  \includegraphics[width=1\linewidth]{assets/content/10-ModificationESP/InterfaceWeb.png}
  \caption{Interface utilisateur finale}
  \label{fig:InterfaceFinal}
\end{figure}