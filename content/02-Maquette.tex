...
$$I = \text{ADC}_{lu} \cdot \frac{I_{max} - I_{min}}{\text{ADC}_{max}} - I_{offset}$$

En appliquant les valeurs numériques propres au capteur de courant :

\begin{equation}
    I = \text{ADC}_{lu} \cdot \frac{30 - (-30)}{3723} - 30 = 0,01612 \cdot \text{ADC}_{lu} - 30 \quad [\text{A}]
...
\begin{equation}
    \text{Position} = \text{ADC}_{lu} \cdot \frac{3 \cdot 10^{-3} - 0}{3723} = 8,058 \cdot 10^{-7} \cdot \text{ADC}_{lu} \quad [\text{m}]
