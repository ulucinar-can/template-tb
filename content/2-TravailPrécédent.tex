...
Bien que l'ESP32 dispose d'une mémoire limitée, celle-ci devrait s'avérer suffisante (voir \ref{sec:CodeESP32}).\\

Dans l'éventualité où les ressources de la carte deviendraient insuffisantes, il sera néscessaire de réaliser une modification de la carte principale du système afin d'accepter une autre carte. La version 3 de la carte ayant un pinout entièrement différent (voir \autoref{annexe:PinoutCarbon}).\\
