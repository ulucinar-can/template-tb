...
\subsection{DSP}
La carte principale est celle où se situe le cerveau du système. C'est ici que se trouve le DSP et les circuits de contionnements.\\

\subsection{Conditionneur}
\label{subsec:Conditionneur}

Le DSP possède le programme principal qui permet de réaliser une lévitation. La schématique
