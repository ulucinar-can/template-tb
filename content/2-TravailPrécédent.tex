...
\begin{itemize}
    ...
    \item Un régulateur de 24 V utilisé pour alimenter l'ensemble des autres régulateurs. Ce dernier est alimenté par le bus 48 V dans les deux positions du switch de précharge, garantissant ainsi l'alimentation continue de la carte.
...
Le circuit de précharge permet d'apporter doucement
