...
\subsection{ESP32}
L'ESP32 est une petite carte qui, dans le projet, va permettre d'avoir une interface web afin que les utilisateurs puissent manier différente info. La carte employée est la carte Carbon S2 réalisé par GroundStudio \cite{ESP32}.\\

Du datasheet \cite{ESP32}, les informations suivantes peuvent être récupérées :\\

Microcontroller : ESP32-S2FN4R2
\begin{itemize}
    \item 128KB ROM for booting and basic functions
    \item 320KB SRAM for data instructions
    \item 16 KB SRAM in RTC
\end{itemize}

USB-Serial converter: ESP32-S2 integrated internally
Voltage regulator 3.3V: ME6211C33U4AG-N
GPIO pins: 18
USB 2.0 type C adapter
ROM memory: 128 KB
SRAM memory: 320 KB
Interfaces: ADC, DAC, SD/SDIO/MMC Host Controller, SPI, SDIO/SPI Slave Controller,
EMAC, PWM motor, PWM LED, UART, I2C, I2S, GPIO
Maximum processor frequency: 240 MHz
Dimensions approx. pcb: 37mm x 18mm
