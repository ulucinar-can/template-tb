...
À partir du compiler d'Arduino, il est possible de réaliser une vérification de l'espace prise dans la mémoire de l'ESP32. De cela on obtient les informations suivante :
