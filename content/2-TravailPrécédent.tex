...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{Image/Chap.2/SchemFonct.png}
    \caption{Schéma fonctionnel \cite{Freyche}}
    \label{fig:SchemFonct}
\end{figure}

Les éléments suivants constituent la maquette :

\begin{itemize}
    \item La carte principale intégrant l'unité de traitement du système.
    \item Les inducteurs et les chariots.
    \item Une alimentation générale de 48 V.
\end{itemize}

Ces différents composants sont détaillés dans les sous-sections suivantes.
...
\subsection{Carte principale (DSP)}
La carte principale est celle ou se situe le cerveau du système.
