...
La régulation est le gros de l'interruption principale. Elle doit normalement suivre les étapes suivantes :
...
La stratégie de take-off pour les inducteurs 3 et 4 sont identiques à celle de la stratégie de take-off 1 et 2. C'est pourquoi celle-ci ne sera pas détaillée.
