...
Les cartes de précharges sont représenté par l'image suivante :

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth,page=3]{Image/AnnexeShemaElectrique/TB_TFE_Sust_Mag_1_0_0.pdf}
    \caption{Circuits des cartes de puissances \cite{Laucella}}
    \label{fig:PowerSchem}
\end{figure}

Cette carte est en réalité un pont en H. Un signal PWM envoie
