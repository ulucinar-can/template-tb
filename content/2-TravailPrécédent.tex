...
Dans l'éventualité où les ressources de la carte deviendraient insuffisantes, deux options seraient envisageables : le remplacement par un modèle doté d'une capacité de stockage supérieure ou, dans un cas plus critique, une modification de la carte principale du système afin d'accepter une autre carte.\\
...
La phase 2 concerne la montée des deux inducteurs placée à l'avant. Celle-ci va devoir venir réaliser un décollage de ces deux inducteurs.
