...
\subsubsection{PWM}
Les signaux PWM sont employés pour gérer les ponts en H

Une fois le passage par la régulation de courant réalisée, il est néscessaire de calculer le duty-cycle des signaux PWM employé par les ponts en H des inducteurs. Pour cela les lignes de codes suivantes sont écrites :
