...
\subsection{Arret de la sustentation}
Lorsque le bouton S2 est une nouvelle fois pressé, il faut arreter la sustentation comme suit :
...
\subsubsection{Autre partie du code}
\textbf{Compteur du changement de variable}
La variable qui permet de compter pour atteindre le moment du changement de variable est gérée comme suit :
...
C'est un simple if qui vérifie si on est encore en takeOff ou non.
