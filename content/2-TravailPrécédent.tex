...
\begin{enumerate}
    ...
    \item \texttt{xr1} : On calcule une intégrale à partir de l'erreur et l'antiwindup.
...
Par la suite, on vérifie que la force ne déborde pas en ehors des plages admises dans le cas contraire, on lui force la valeur de la plage.
