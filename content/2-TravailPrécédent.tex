...
\begin{itemize}
    \item Un régulateur de tension à 5V pour l'alimentation du DSP et de l'ESP32. Il prend en entrée 24V.
    ...
    \item Un régulateur de 3.3V est employé pour alimenter l'ESP32. Il prend en entrée le 5V.
    \item
\end{itemize}
