...
\section{Mesure des convertisseur}
Cette section traite des mesures réalisées sur les convetisseurs DC/DC de la carte principale. Ces composants assurent l'alimentation correcte de l'intégralité du système.\\

Le convertisseur 24 V présente les résultats consignés dans le tableau \ref{tab:conv_24v_48v} :
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|c|l|c|c|c|c|c|}
            \hline
            \multicolumn{7}{|c|}{\textbf{Convertisseurs 24V et entrée 48V (PS1)}}                                                                                                                                                           \\ \hline
    ...
    \caption{Mesures sur le convertisseurs 24V et l'entrée 48V (PS1)}
    \label{tab:conv_24v_48v}
\end{table}

Le convertisseur de 15 V présente les résultats consignés dans le tableau \ref{tab:conv_15v} :
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|c|l|c|c|c|c|c|}
            \hline
            \multicolumn{7}{|c|}{\textbf{Convertisseur 15V (PS2)}}                                                                                                                                                                    \\ \hline
            N°  & \multicolumn{1}{c|}{Mesure} & Point de mesure    & \begin{tabular}[c]{@{}c@{}}Valeur théorique\\ {[}V{]}\end{tabular} & \begin{tabular}[c]{@{}c@{}}Valeur\\ mesurée {[}V{]}\end{tabular} & Erreur & Erreur {[}\%]{} \\ \hline
            1.a & Entrée des 24V              & Côté C12 de la C13 & 24                                                                 & 23.07                                                            & 0.93   & 3.88            \\ \hline
            2.a & Sortie du régulateur 15V    & TP1                & 15                                                                 & 14.95                                                            & 0.05   & 0.333           \\ \hline
        \end{tabular}%
    }
    \caption{Mesures sur le convertisseur 15V (PS2)}
    \label{tab:conv_15v}
\end{table}

Le convertisseur de 5 V présente les résultats consignés dans le tableau \ref{tab:conv_5v} :
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|c|l|c|c|c|c|c|}
            \hline
            \multicolumn{7}{|c|}{\textbf{Convertisseur 5V (IC1)}}                                                                                                                                                                  \\ \hline
            N°  & \multicolumn{1}{c|}{Mesure} & Point de mesure & \begin{tabular}[c]{@{}c@{}}Valeur théorique\\ {[}V{]}\end{tabular} & \begin{tabular}[c]{@{}c@{}}Valeur\\ mesurée {[}V{]}\end{tabular} & Erreur & Erreur {[}\%]{} \\ \hline
    ...
    \caption{Mesures sur le convertisseur 5V (IC1)}
    \label{tab:conv_5v}
\end{table}

Le convertisseur de 3,3 V présente les résultats consignés dans le tableau \ref{tab:conv_3_3v} :
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|c|l|c|c|c|c|c|}
            \hline
            \multicolumn{7}{|c|}{\textbf{Convertisseur 3.3V (U6)}}                                                                                                                                                                 \\ \hline
            N°  & \multicolumn{1}{c|}{Mesure} & Point de mesure & \begin{tabular}[c]{@{}c@{}}Valeur théorique\\ {[}V{]}\end{tabular} & \begin{tabular}[c]{@{}c@{}}Valeur\\ mesurée {[}V{]}\end{tabular} & Erreur & Erreur {[}\%]{} \\ \hline
            1.a & Entrée des 5V               & J5 pin 2        & 5                                                                  & 4.982                                                            & 0.018  & 0.360           \\ \hline
            2.a & Sortie du régulateur 3.3V   & TP5             & 3.3                                                                & 3.296                                                            & 0.004  & 0.121           \\ \hline
        \end{tabular}%
    }
    \caption{Mesures sur le convertisseur 3.3V (U6)}
    \label{tab:conv_3_3v}
\end{table}

Le convertisseur de 0,5 V présente les résultats consignés dans le tableau \ref{tab:conv_0_5v} :
