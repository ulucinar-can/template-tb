...
\begin{table}[H]
    ...
    \begin{tabular}{cc}
        \toprule
        \textbf{Calles [mm]} & \textbf{Entrefer [mm]} \\
        \midrule
        0                    & 3                      \\
        1                    & 2                      \\
        1.5                  & 1.5                    \\
...
\begin{itemize}
    \item L'hypothèse d'une modification de la masse totale est \textbf{confirmée} : la pesée a révélé 18.052~kg au lieu des 13.6~kg considérés jusqu'ici, ce qui fausse les paramètres de la régulation.
    \item L'hypothèse d'un défaut matériel de la carte principale est \textbf{partiellement confirmée} : une broche mal soudée sur le convertisseur 24~V a été détectée et corrigée, mais le reste de l'électronique fonctionne de manière nominale.
    \item L'hypothèse d'une mauvaise calibration globale \textbf{reste ouverte} : aucune correction des capteurs de position n'a suffi à rétablir la lévitation, et la découverte de l'ondulation de la plaque de référence oriente les recherches vers la mesure de cette dernière.
\end{itemize}
