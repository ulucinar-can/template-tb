...
\section{Mesure du poids}
Le poids fut mesurer. Pour ce faire, les poids visser à l'avant de la maquette furrent retirer afin d'y extraire la partie en lévitation. Celle- ci fut alors mesuré au moyen d'une balance disponible au MakeLab ainsi qu'une plaque pour correctement répartir le poids :

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{assets/Chap3/MesureMasse.jpeg}
    \caption{Mesure de la masse total de la partie en lévitation}
\end{figure}

À la suite d’une mesure de masse, la partie lévitante ne pèse pas 13,6 kg, comme indiqué dans les travaux précédents, mais 18,052 kg.
