...
Selon le même principe, des essais ont été effectués en ajoutant une masse d'environ 1,25 kg. Afin de garantir une précision maximale, ces masses ont été pesées au préalable pour obtenir une valeur de charge exacte. Les mesures correspondantes sont présentées dans le tableau \ref{tab:poids_1_25_comp} :
