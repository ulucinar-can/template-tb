...
\begin{figure}[H]
    ...
    \caption{Évolution du circuit de précharge réalisée par Thomas Freyche \cite{Freyche}}
...
La calibration a été réalisée à une même hauteur en suivant les étapes décrites dans la \autoref{sec:CalibrationCaptPosManuel}.
...
Les mesures sont réalisées en affichant la valeur de l'ADC filtré sur l'interface web.
