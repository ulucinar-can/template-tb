...
La mesure de la carte principale permet de vérifier plusieurs des hypothèses émises, telles que :
...
La calibration a été réalisée à une même hauteur en suivant les étapes décrites dans l'annexe \ref{sec:CalibrationCaptPosManuel}.
...
Les performances n'étant toujours pas satisfaisantes, un dernier essai reposant sur une simple équation linéaire a été mené, donnant les tracés des figures \ref{fig:Ind1Lin} à \ref{fig:Ind4Lin} :
