...
La calibration fut réaliser à une meme hauteur en suivant les étapes décrites dans l'annexe \ref{sec:CalibrationCaptPosManuel} concernant la calibration.
...
Ces corrections furent réaliser précédemment la découverte que la plaque de références fut en réalité ondulé faussant ainsi grandement les résultat obtenues.

Il est toutefois intéressant de noter que la calibration « Teach-In » de l'ensemble des capteurs à un niveau de référence commun a semblé améliorer légèrement la stabilité de maintien de la maquette. Mais cette référence néscessite une nouvelle fois une bonne référence.
