...
Les parties qui furent allouer à la ram sont :

\begin{itemize}
    \item L'interruption principale
    \item Les deux interruptions lié à la communication UART
...
\section{Conclusion}
Les différentes implémentation réaliser ont permis d'obtenir un code bien plus structurer que ceux réaliser jusqu'à maintenant.
