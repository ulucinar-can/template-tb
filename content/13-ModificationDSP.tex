...
Avec les coefficients provenant du travail de Yersin \cite{Yersin} :
...
Différentes modifications ont été apportées au code. N'ayant pas d'impact majeur mais concernant plutôt la structure du code, elles sont décrites dans cette section.
