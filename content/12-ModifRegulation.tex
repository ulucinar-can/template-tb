...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{assets/content/12-ModifRegulation/SautInd1.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{assets/content/12-ModifRegulation/SautInd2.pdf}
...
\subsection{Définition de la position des inducteur}
Pour commencer, il est néscessaire de définir ou se situe chaque inducteur dans l'espace. Pour cela, le centre de gravité fut dès lors fixé au point milieu de la plaque