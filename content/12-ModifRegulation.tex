...
Le filtre de Savitzky--Golay, employé en SISO pour estimer la vitesse par dérivation, a été remplacé par un observateur (\autoref{subsec:observateur}). Cela retire un retard de la boucle et évite l'amplification du bruit propre à une dérivation numérique.
...
\begin{equation}
    p_k = \bigl\{-80,\ -85,\ -90,\ -25\bigr\}\ \mathrm{rad/s}
\end{equation}
