...
La grandeurs manquette est celle de l'oscillation. C'est justement elle qui va être mesuré lorsque la maquette sera suspendue vérticalement par axe.

Pour se faire, il faut se munir de l'équipement qui suit :

de 2 cables. Plus les câbles sont long, plus la mesure est fiable.

\subsection{Définition de l'espace d'état}


\section{Observateur sur la vitesse}
