...
Un élargissement de la fenêtre de glissement permet de renforcer l'atténuation du bruit, mais ce lissage s'obtient au détriment du temps d'exécution (charge processeur). Ce filtre est spécifiquement exploité dans le firmware pour calculer la dérivée de la position et filtrer le résultat afin d'obtenir la vitesse :
