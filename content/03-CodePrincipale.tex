...
\subsection{La fonction \texttt{SendFloatToText}}
La fonction \texttt{SendFloatToText} est la fonction permettant la transmission des données des positions sur l'interface web. La fonction est la suivante :
