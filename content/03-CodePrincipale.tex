...
Le programme possède plusieurs interruptions. La principale, dénommée \texttt{adcA1ISR}, exécute l'algorithme du programme. Cette interruption correspond donc à l'algorithme de base décrit dans la \autoref{sec:Algo}.
