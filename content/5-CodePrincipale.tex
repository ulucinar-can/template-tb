...
% [Insère ton tableau tab:verif_temps_final ici]
...
\begin{itemize}
    ...
    \item Etat 3 : Lorsque l'inducteur 1&2 commencent à bouger, on les passe en régulation de position (lévitation de l'avant du véhicule).
    ...
    \item Etat 6 : Lorsque l'inducteur 3&4 commencent à bouger, on les passe en régulation de position (lévitation de l'arrière du véhicule, l'avant lévite déjà).
...
En suivant ces informations, le schéma suivant fut réaliser :
